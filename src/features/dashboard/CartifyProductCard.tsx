...
export default function CartifyProductCard({ product }: Props) {
  return (
    <Link to={`/CartifyProductDetails/${product.id}`}>
      <div className="card card-bordered bg-base-200 w-full hover:shadow-lg">
        <figure>
