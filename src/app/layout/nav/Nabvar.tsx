  ...
  return (
    <header className="w-full fixed h-20 top-0 z-50 bg-gray-300">
      <div className="flex items-center justify-between h-full px-10 mx-auto gap-6">
        <a className="flex items-center gap-3 h-full overflow-hidden">
          <img src="./public/cartify.png" alt="logo" className="h-48 max-h-48 w-auto object-contain hover:cursor-pointer" />
        </a>
